...
This introduces the fundamental problem of causal inferencia. We only observe each unit either in the treatment or control group. 
...
However, this rises the problem of selection bias. People that were treated are not the equal in observables nor unobersables to the ones treated. This sets the need for *Randomized Control Trials*. 
...
This is posbbile because random assignment assures observable baseline characterics of treatment groups should be similar, statistical unsignificant. This is *balance* of covariates: 
